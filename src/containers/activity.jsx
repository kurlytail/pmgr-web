...
class Activity extends Component {
    render() {
        ...
        const managerName = this.props.activity.manager || this.props.project.manager;
                ...
                <div className="card-header">
                    <div className="row">
                        <div className="col col-10">
                            <h1 className="text-muted">Activity</h1>
                            ...
                            <InlineEdit
                                ...
                                text={this.props.activity.summary || ''}
                                paramName="summary"
                    ...
                    <div className="row">
                        <div className="col">
                            <InlineEdit
                                ...
                                text={this.props.activity.description || ''}
                            ...
                            <div className="row">
                                <div className="col">
                                    <div className="card card-body">
                                        <div className="row">
                                            <div className="col-4">{this.props.activity.progress || 0}%</div>
                                            <div className="col">
                                                <Slider
                                                    min={0}
                                                    max={100}
                                                    value={this.props.activity.progress || 0}
                                ...
                                <div className="col-4">
                                    <div className="card-body">
                                        {this.props.activity.complete
                                            ? 'Completed'
                                            : this.props.activity.started ? 'In progress' : 'Not started'}
                                    </div>
                                </div>
                                <div className="col">
...
const mapProps = (state, props) => {
    return {
        ...
        activity: state.app.local.activities[props.match.params.project][props.match.params.activity]
    };
};
...
const mapDispatch = (dispatch, props) => {
    return {
        configure: (...params) => {
            dispatch(
                ActivityReducer.activityConfigure(props.match.params.project, props.match.params.activity, ...params)
            );
        }
    };
};

const doc = connect(mapProps, mapDispatch)(Activity);
export default doc;
